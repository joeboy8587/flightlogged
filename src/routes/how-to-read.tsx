...
const SECTIONS: Section[] = [
  {
    ...
    how: [
      ...
      { label: "Red rows", desc: "Correlated event — anomaly plus biometric spike, low altitude, or operator history." },
  ...
  },
  {
    ...
    what: "Completed anomaly investigations that cleared the Four-Factor Lock: ADS-B detection + flight tracking screenshot + biometric correlation + timeline alignment.",
    why: "A single low-altitude flyover is noise. A pattern of low-altitude flyovers during biometric events, by aircraft linked to the same operator cluster, is signal. Findings are where signal gets a case number.",
    how: [
      ...
      { label: "Biometric correlation", desc: "Heart rate / HRV spike if logged by an affected resident." },
  ...
  },
  {
    ...
    what: "A composite score derived from anomaly frequency, operator clustering, altitude deviation severity, biometric correlation strength, and temporal concentration.",
  ...
  },
  {
    ...
    how: [
      { label: "1. Sensors listen", desc: "Public ADS-B + opt-in biometric inputs." },
      ...
      { label: "4. Correlations lock", desc: "Biometric + temporal + spatial alignment." },
