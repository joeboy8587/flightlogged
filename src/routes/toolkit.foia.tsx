...
export const Route = createFileRoute("/toolkit/foia")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://advocacywatch.live/toolkit/foia" },
    ],
    links: [{ rel: "canonical", href: "https://advocacywatch.live/toolkit/foia" }],
...
function FoiaBuilder() {
  ...
  const letter = useMemo(() => {
    ...
    return [
      ...
      ``,
      `---`,
      `Generated by Watchtower Toolkit — https://advocacywatch.live/toolkit/foia`,
